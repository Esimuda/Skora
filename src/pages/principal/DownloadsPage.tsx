...
export const DownloadsPage = () => {
  ...
  const handleRequestUnlock = async () => {
    if (!schoolId) return;
    if (physicalScope === "class" && !physicalClassId) {
    ...
    try {
      const unlock = await api.post<DownloadUnlock>(`/schools/${schoolId}/download-unlocks`, {
        ...
        scope: physicalScope,
        ...(physicalScope === "class" ? { classId: physicalClassId } : {}),
      });
                  ...
                  <div className="p-5">
                    {schoolUnlock ? (
                      ...
                      <div className="flex items-center justify-between gap-4 flex-wrap">
                        ...
                        <button
                          onClick={() => { setPhysicalScope("school"); handleRequestUnlock(); }}
                        ...
                        <div className="px-4 py-3">
                          {isUnlocked ? (
                            ...
                            <div className="flex items-center justify-between gap-4 flex-wrap">
                              ...
                              <button
                                onClick={() => { setPhysicalScope("class"); setPhysicalClassId(s.classId); setTimeout(handleRequestUnlock, 0); }}
                              ...
                              >
                                {requestingUnlock && physicalClassId === s.classId ? (
